...
def login():
    ...
    form = LoginForm(request.form) # request.form se usa para obtener los datos enviados por el formulario
...
def register():
    ...
    form = RegisterForm(request.form) # request.form se usa para obtener los datos enviados por el formulario
...
@login_required
def new_task():
    form = TaskForm(request.form) # request.form se usa para obtener los datos enviados por el formulario
